...
<div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gray-50 p-8 sm:p-12 dark:bg-gray-900">
    <div class="w-full max-w-4xl rounded-md border-2 border-gray-100 dark:border-gray-700 bg-white p-14 dark:bg-gray-900">
      <div class="flex flex-col items-center">
        ...
        <form class="mx-auto mt-4 flex w-full max-w-md flex-col gap-3 sm:flex-row sm:gap-0" name="contact" method="POST" data-netlify="true">
          ...
          <button type="submit" class="rounded bg-emerald-500 px-5 py-4 font-bold text-white sm:rounded-l-none sm:rounded-r-md">Subscribe</button>
        </form>
      </div>
    </div>
  </div>
